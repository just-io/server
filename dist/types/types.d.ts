...
export type RequestFinishedReason = 'not-found' | 'length-required' | 'content-too-large' | 'not-acceptable' | 'timeout' | 'too-many-requests' | 'internal-server-error' | 'socket-closed' | 'handled' | 'error';
